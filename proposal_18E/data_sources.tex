...
\todo{RF-5b (post-Sandia-meeting): after the 2026-04-09 meeting with Co-PI Steinmetz, swap in the specific Sandia Kokkos/Trilinos/LAMMPS corpus subsets, benchmark logs, and validation artifacts accessible under existing Sandia data agreements. Cite the data agreement and name the specific code subsets. If no specific commitment is secured, keep this Plan B wording and add a sentence framing Sandia's role as ``secondary domain validation.''}
